...
#define MIRANDA_VERSION_FILEVERSION 0,10,0,5                                
#define MIRANDA_VERSION_STRING      "0.10.0.5"                              
#define MIRANDA_VERSION_DISPLAY     "0.10.0 alpha build #5"                 
#define MIRANDA_VERSION_DWORD       MIRANDA_MAKE_VERSION(0, 10, 0, 5)       
