...
static struct _tagPages {
	...
	{ CTranslator::CNT_OPT_TITLE_TITLEBAR, CTranslator::STR_LAST, IDC_O_HIDETITLE, IDC_STATICICON, IDC_TITLEFORMAT, IDC_O_TITLEBARFORMAT, IDC_O_HELP_TITLEFORMAT, 0, 0, 0, 0, 0},
		...
		case WM_COMMAND:
			switch (LOWORD(wParam)) {
				...
				case IDC_O_HELP_TITLEFORMAT:
					CallService(MS_UTILS_OPENURL, 1, (LPARAM)"http://miranda.or.at/TitleBarFormatting");
					break;
