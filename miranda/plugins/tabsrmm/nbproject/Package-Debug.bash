...
OUTPUT_PATH=dist/Debug/${PLATFORM}/libtabsrmm.dll
...
# Generate tar file
cd "${TOP}"
rm -f dist/Debug/${PLATFORM}/package/libtabsrmm.dll.tar
cd ${TMPDIR}
tar -vcf ../../../../dist/Debug/${PLATFORM}/package/libtabsrmm.dll.tar *
checkReturnCode
