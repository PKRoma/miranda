...
OUTPUT_PATH=dist/Release/${PLATFORM}/libtabsrmm.dll
...
# Generate tar file
cd "${TOP}"
rm -f dist/Release/${PLATFORM}/package/libtabsrmm.dll.tar
cd ${TMPDIR}
tar -vcf ../../../../dist/Release/${PLATFORM}/package/libtabsrmm.dll.tar *
checkReturnCode
