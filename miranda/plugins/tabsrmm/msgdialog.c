...
// XXX tab mod
        ...
        case WM_RBUTTONUP: {
            ...
            isHandled = MsgWindowMenuHandler(hwndDlg, dat, iSelection);
            if(isHandled)
                _DebugPopup(dat->hContact, "menu selection was handled");
            break;
        }
        case WM_MOUSEMOVE:
            {
...
// END /all /MOD
                ...
                case IDC_TIME: {
                    ...
                    switch (TrackPopupMenu(submenu, TPM_RETURNCMD, rc.left, rc.bottom, 0, hwndDlg, NULL)) {
