...
OUTPUT_PATH=dist/Release/${PLATFORM}/clist_nicer.dll
...
# Generate tar file
cd "${TOP}"
rm -f dist/Release/${PLATFORM}/package/libclistnicer.dll.tar
cd ${TMPDIR}
tar -vcf ../../../../dist/Release/${PLATFORM}/package/libclistnicer.dll.tar *
checkReturnCode
