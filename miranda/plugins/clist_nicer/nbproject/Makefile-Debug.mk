...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/${PLATFORM}/libclist_nicer.dll

dist/Debug/${PLATFORM}/libclist_nicer.dll: ${OBJECTFILES}
	${MKDIR} -p dist/Debug/${PLATFORM}
	${LINK.cc} -shared -o dist/Debug/${PLATFORM}/libclist_nicer.dll -s ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/utf.o: utf.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -s -D__GNUWIN32__ -I../../include -I../../include/mingw -MMD -MP -MF $@.d -o ${OBJECTDIR}/utf.o utf.c
...
.clean-conf:
	${RM} -r build/Debug
	${RM} dist/Debug/${PLATFORM}/libclist_nicer.dll
