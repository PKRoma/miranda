...
static StatusItems_t StatusItems[] = {
	...
	CLCDEFAULT_COLOR, CLCDEFAULT_COLOR2, CLCDEFAULT_COLOR2_TRANSPARENT, CLCDEFAULT_ALPHA, CLCDEFAULT_MRGN_LEFT, 
	...
	CLCDEFAULT_GRADIENT,CLCDEFAULT_CORNER,
	CLCDEFAULT_COLOR, CLCDEFAULT_COLOR2, CLCDEFAULT_COLOR2_TRANSPARENT, 0, CLCDEFAULT_MRGN_LEFT, 
	CLCDEFAULT_MRGN_TOP, CLCDEFAULT_MRGN_RIGHT, CLCDEFAULT_MRGN_BOTTOM, 1
	},
...
// fills the combobox of the opeions dlg for the first time
...
void FillOptionDialogByStatusItem(HWND hwndDlg, StatusItems_t *item)
{
	...
	ret = item->COLOR2;
	SendDlgItemMessage(hwndDlg,IDC_BASECOLOUR,CPM_SETDEFAULTCOLOUR,0,CLCDEFAULT_COLOR2);
