...
CLEAN :
	...
	-@erase "$(OUTDIR)\toolbar_icons.lib"
	-@erase "$(OUTDIR)\toolbar_icons.pdb"
...
CPP=cl.exe
CPP_PROJ=/nologo /MT /W3 /GX /Zi /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_USRDLL" /D "ICONS_EXPORTS" /D "_MBCS" /Fp"$(INTDIR)\ICONS_MODERN.pch" /Yu"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\toolbar_icons.pdb" /debug /machine:IX86 /out:"..\..\..\bin\Release\Icons\toolbar_icons.dll" /implib:"$(OUTDIR)\toolbar_icons.lib" /pdbtype:sept /noentry /ALIGN:4096 /ignore:4108 
LINK32_OBJS= \
	"$(INTDIR)\ICONS.res"
