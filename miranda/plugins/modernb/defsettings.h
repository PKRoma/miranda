...
#undef  CLCDEFAULT_QUICKSEARCHCOLOUR
#undef  CLCDEFAULT_SELBKCOLOUR
#undef  CLCDEFAULT_HOTTEXTCOLOUR
...
#define SETTINGS_SHOWBUTTONBAR_DEFAULT			     0 //"CLUI","ShowButtonBar"
//////////////////////////////////////////////////////////////////////////
// ROW SETTINGS
...
#define CLCDEFAULT_TEXTCOLOUR        RGB(0,0,0)       //GetSysColor(COLOR_WINDOWTEXT)
#define CLCDEFAULT_SELTEXTCOLOUR     RGB(0,0,128)     //GetSysColor(COLOR_HIGHLIGHTTEXT)
#define CLCDEFAULT_HOTTEXTCOLOUR     RGB(0,0,255)     //(IsWinVer98Plus()?:GetSysColor(COLOR_HOTLIGHT))
