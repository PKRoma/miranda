...
{
	HWND hwnd;
	hwnd=CreateWindowEx(g_proc_SetLayeredWindowAttributesNew?WS_EX_LAYERED:0,CLUIFrameSubContainerClassName,TEXT("SubContainerWindow"),WS_POPUP|!g_CluiData.fLayered?WS_BORDER:0/*|WS_THICKFRAME*/,x,y,width,height,parent,0,g_hInst,0);
