	...
	else if (GetProtocolVisibility(szChangedProto))
	{
			...
			//??	
					{ 
						...
						changed=TrayIconSetBaseInfo(ImageList_GetIcon(himlCListClc,pcli->pfnIconFromStatusMode(szChangedProto,averageMode),ILD_NORMAL),workAround?szChangedProto:NULL);
					}
	};
