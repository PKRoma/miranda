...
!IF "$(CFG)" == ""
CFG=db3x_mmap - Win32 Release
!MESSAGE No configuration specified. Defaulting to db3x_mmap - Win32 Release.
!ENDIF
...
"$(INTDIR)\utf.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\db3x_mmap.pch"


!ELSEIF  "$(CFG)" == "db3x_mmap - Win32 Debug"


"$(INTDIR)\utf.obj"	"$(INTDIR)\utf.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\db3x_mmap.pch"
