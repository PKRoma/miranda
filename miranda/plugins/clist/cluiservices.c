...
static int ListEndRebuild(WPARAM wParam, LPARAM lParam)
{
    ...
    if ((DBGetContactSettingByte(NULL, "CList", "HideOffline", SETTING_HIDEOFFLINE_DEFAULT) == 0) !=
        ((GetWindowLong(hwndContactTree, GWL_STYLE) & CLS_HIDEOFFLINE) == 0)) {
    ...
    if ((DBGetContactSettingByte(NULL, "CList", "HideEmptyGroups", SETTING_HIDEEMPTYGROUPS_DEFAULT) == 0) !=
        ((GetWindowLong(hwndContactTree, GWL_STYLE) & CLS_HIDEEMPTYGROUPS) == 0)) {
    ...
    if ((DBGetContactSettingByte(NULL, "CList", "UseGroups", SETTING_USEGROUPS_DEFAULT) == 0) !=
        ((GetWindowLong(hwndContactTree, GWL_STYLE) & CLS_USEGROUPS) == 0)) {
