...
void BeginRenameSelection(HWND hwnd,struct ClcData *dat)
{
	...
	dat->hwndRenameEdit=CreateWindow("EDIT",contact->szText,WS_CHILD|WS_BORDER|ES_AUTOHSCROLL,x,y,clRect.right-x,dat->rowHeight,hwnd,NULL,GetModuleHandle(NULL),NULL);
