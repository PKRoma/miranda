	...
	switch (msg)
	{
		case WM_INITDIALOG:
			...
			{	HIMAGELIST hIml;
				...
				ImageList_AddIcon_IconLibLoaded(hIml,LoadSkinnedIcon(SKINICON_STATUS_INVISIBLE));
				ImageList_AddIcon_IconLibLoaded(hIml,LoadSkinnedIcon(SKINICON_STATUS_OFFLINE));
