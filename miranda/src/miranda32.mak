...
"$(INTDIR)\descbutton.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\miranda32.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\headerbar.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\miranda32.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\iconheader.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\miranda32.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
