...
DWORD_PTR __cdecl CJabberProto::GetCaps( int type, HANDLE hContact )
{
	...
	case PFLAGNUM_2:
		return PF2_ONLINE | PF2_INVISIBLE | PF2_SHORTAWAY | PF2_LONGAWAY | PF2_HEAVYDND | PF2_FREECHAT | PF2_ONTHEPHONE;
	case PFLAGNUM_3:
		return PF2_ONLINE | PF2_SHORTAWAY | PF2_LONGAWAY | PF2_HEAVYDND | PF2_FREECHAT | PF2_ONTHEPHONE;
	case PFLAGNUM_4:
