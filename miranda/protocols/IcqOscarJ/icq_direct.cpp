...
static void RemoveDirectConnFromList(directconnect* dc)
{
  int i;
...
void icq_newConnectionReceived(HANDLE hNewConnection, DWORD dwRemoteIP, void *pExtra)
{
  ...
  ICQCreateThread((pThreadFuncEx)icq_directThread, CreateDTSI(NULL, hNewConnection, -1));
}
...
void OpenDirectConnection(HANDLE hContact, int type, void* pvExtra)
{
  ...
  ICQCreateThread((pThreadFuncEx)icq_directThread, dtsi);
}
