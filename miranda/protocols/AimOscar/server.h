...
void snac_md5_authkey(SNAC &snac,HANDLE hServerConn,int &seqno);
int snac_authorization_reply(SNAC &snac);
void snac_supported_families(SNAC &snac, HANDLE hServerConn,int &seqno);
void snac_supported_family_versions(SNAC &snac,HANDLE hServerConn,int &seqno);
void snac_mail_supported_family_versions(SNAC &snac,HANDLE hServerConn,int &seqno);//family 0x0001
void snac_rate_limitations(SNAC &snac,HANDLE hServerConn,int &seqno);//faimly 0x0001
