...
echo             VALUE "LegalCopyright", "Copyright © 2000-2008 Miranda IM Project. This software is released under the terms of the GNU General Public License.\0"    >>..\src\version.rc
