...
#ifdef TCP_TRACE_ODS
{char str[128];
  sprintf(str,"message packet sent to uin %lu { sequence=%lx }\n", uin, p->id);
...
#ifdef TCP_TRACE_ODS
{char str[128];
  sprintf(str,"url packet queued for uin %lu { sequence=%lx }\n", uin, p->id);
  OutputDebugString(str);}
#else
...
#ifdef TCP_TRACE_ODS
{char str[128];
  sprintf(str,"chat req packet sent to uin %lu { sequence=%lx }\n", uin, p->id);
  OutputDebugString(str);}
#else
...
#ifdef TCP_TRACE_ODS
{char str[128];
  sprintf(str,"file req packet sent to uin %lu { sequence=%lx }\n", uin, p->id);
  OutputDebugString(str);}
#else
...
#ifdef TCP_TRACE_ODS
{char str[128];
  sprintf(str,"chat req ack sent to uin %lu { sequence=%lx }\n", uin, sequence);
  OutputDebugString(str);}
#else
...
#ifdef TCP_TRACE_ODS
{char str[128];
  sprintf(str,"file req ack sent to uin %lu { sequence=%lx }\n", uin, sequence);
  OutputDebugString(str);}
#else
...
#ifdef TCP_TRACE_ODS
{char str[128];
  sprintf(str,"file req refuse sent to uin %lu { sequence=%lx, reason=\"%s\" }\n",
    uin, sequence, reason);
  OutputDebugString(str);}
#else
...
#ifdef TCP_TRACE_ODS
{char str[128];
  sprintf(str,"file req cancel sent to uin %lu { sequence=%lx }\n", uin, sequence);
  OutputDebugString(str);}
#else
...
#ifdef TCP_TRACE_ODS
{char str[128];
  sprintf(str,"chat req refuse sent to uin %lu { sequence=%lx, reason=\"%s\" }\n",
    uin, sequence, reason);
  OutputDebugString(str);}
#else
...
#ifdef TCP_TRACE_ODS
{char str[128];
  sprintf(str,"chat req cancel sent to uin %lu { sequence=%lx }\n", uin, sequence);
  OutputDebugString(str);}
#else
