...
static int MsnGetCaps(WPARAM wParam,LPARAM lParam)
{
	if(wParam==PFLAGNUM_1)
		return PF1_IM|PF1_SERVERCLIST|PF1_AUTHREQ|PF1_BASICSEARCH|PF1_ADDSEARCHRES|PF1_SEARCHBYEMAIL|PF1_USERIDISEMAIL;
...
int LoadMsnServices(void)
{
	...
	CreateServiceFunction(MSNPROTONAME PS_SEARCHBYEMAIL,MsnBasicSearch);
