...
if (!$ARGV[0] or $ARGV[0] eq "icq") {
    create_langfile('../../miranda/protocols/IcqOscarJ/', '../../miranda/protocols/IcqOscarJ/docs/IcqOscarJ-translation.txt', 'English (US)', '0809', 'Martin Öberg, Richard Hughes, Jon Keating', 'info@miranda-im.org');
}
...
if (!$ARGV[0] or $ARGV[0] eq "yahoo") {
    create_langfile('../../miranda/protocols/Yahoo/', '../../miranda/protocols/Yahoo/docs/translation.txt', 'English (US)', '0809', 'Gennady Feldman', 'gena01@miranda-im.org');
}
...
sub create_langfile {
    ...
    print WRITE "Last-Modified-Using: Miranda IM 0.5\n";
