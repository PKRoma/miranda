...
if (!$ARGV[0] or $ARGV[0] eq "miranda") {
    create_langfile('../../miranda/src', '../../miranda/i18n/langpack_english.txt', 'English (US)', '0809', 'Miranda IM Development Team', 'project-info@miranda-im.org');
}
if (!$ARGV[0] or $ARGV[0] eq "srmm") {
    create_langfile('../../miranda/plugins/SRMM/', '../../miranda/plugins/SRMM/Docs/srmm-translation.txt', 'English (US)', '0809', 'Miranda IM Development Team', 'project-info@miranda-im.org');
}
if (!$ARGV[0] or $ARGV[0] eq "import") {
    create_langfile('../../miranda/plugins/Import/', '../../miranda/plugins/Import/docs/import-translation.txt', 'English (US)', '0809', 'Miranda IM Development Team', 'project-info@miranda-im.org');
}
...
sub create_langfile {
    ...
    print WRITE "Last-Modified-Using: Miranda IM 0.6.1\n";
